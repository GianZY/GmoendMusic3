...
module.exports = async (client) => {
  await client.user.setPresence({
    activities: [
      {
        name: `Gmoend | ${client.prefix}help`,
  ...
  client.endEmbed = new client.embed()
    .desc(
      `**Menikmati Musik bersama saya ?**\n` +
        `Jika ya, Pertimbangkan [Bergabunglah dengan Server Kami](https://discord.com/invite/daEGxSMVRF)`,
    )
    ...
    .setFooter({ text: "Powered by Gmoend" });
