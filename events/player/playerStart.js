...
module.exports = {
  ...
  run: async (client, player, track) => {
    ...
    const ad = new client.embed()
      .desc(
        `Konten bersponsor [ Berakhir dalam 10detik]\n` +
          `**Ingin AD server Anda di sini? Bergabunglah dengan [Server Dukungan](${client.support})**`,
      )
      .img("https://telegra.ph/file/2728c85e9927ebd48a04a.gifKonten bersponsor [ Berakhir dalam 10 detik ? Bergabunglah dengan [Layanan Dukungan")
      .setFooter({
        text: `Sponsorlah yang membantu kami menjaga layanan kami tetap gratis bagi pengguna. ㅤㅤ ㅤㅤㅤ`,
      });
