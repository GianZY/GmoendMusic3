...
module.exports = {
  ...
  execute: async (client, message, args, emoji) => {
    ...
    const helpLinks = ` ## [Help Panel](https://discord.gg/DApdRsEFtb) `;
    ...
    const embed = new client.embed()
      ...
      .setFooter({
        text: `Gmoend | Gunakan (gmusic!help) untuk melihat optionsㅤㅤㅤ ㅤㅤ ㅤㅤㅤ`,
      });
    ...
    const all = new client.embed()
      .setDescription(desc)
      .setFooter({
        text: `Powered By Gmoendㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤ`,
      });
          ...
          await m.edit({
            embeds: [
              new client.embed()
                ...
                .setFooter({
                  text: `GMOEND!ㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤㅤ`,
                }),
            ],
          }).catch(() => {});
          break;
